...
import { Edit, Trash2, Plus, Search, Filter, MoreVertical, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="min-h-screen bg-zinc-50/50 dark:bg-zinc-900/50 p-6 md:p-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Products</h1>
                        <p className="text-zinc-500 dark:text-zinc-400 mt-1">Manage your product catalog, inventory, and pricing.</p>
                    </div>
                            ...
                            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                                {loading ? (
                                    ...
                                    paginatedProducts.map((product) => (
                                        <tr key={product._id} className="group hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
